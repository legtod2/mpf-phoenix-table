...
class TestSimpleGame(FullMachineTestCase):
    ...
    def test_single_player_game(self):
        ...
        # Score should add up to 29,030
        self.assertEqual(29030, self.machine.game.player.score)
        ...
        self.hit_and_release_switch("s_bullseye")
        self.advance_time_and_run(1)
        # Score should add up to 119,030
...
# Check to see if extraball awarded
        ...
        self.hit_and_release_switch("s_lane5")
        self.advance_time_and_run(1)
        # Score should add up to 319,030
        ...
        self.hit_and_release_switch("s_lane1")
        self.advance_time_and_run(.5)
        # Score should add up to 353,030
        self.assertEqual(353030, self.machine.game.player.score)
        ...
        self.assertEqual(364130, self.machine.game.player.score)
        ...
        self.hit_and_release_switch("s_flipper_right")
        self.hit_and_release_switch("s_flipper_right")
        self.hit_and_release_switch("s_start")  # D
        self.advance_time_and_run()
        self.assertTextOnTopSlide("D")
        self.hit_and_release_switch("s_flipper_left")
        self.hit_and_release_switch("s_flipper_left")
        self.hit_and_release_switch("s_flipper_left")
        self.hit_and_release_switch("s_start")  # DA
        self.advance_time_and_run()
        self.assertTextOnTopSlide("DA")
        self.hit_and_release_switch("s_flipper_right")
        self.hit_and_release_switch("s_flipper_right")
        self.hit_and_release_switch("s_flipper_right")
        self.hit_and_release_switch("s_start")  # DAD
        self.advance_time_and_run()
        self.assertTextOnTopSlide("DAD")
        self.hit_and_release_switch("s_start")
        self.advance_time_and_run()
